      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(height: 20),
            card('Investidor Iniciante', 'Faça seu primeiro investimento', '50',
                'Conquistado em 29/07/2023 às 13:05', 'assets/chart.png'),
            Container(height: 10),
            card(
                'Aprendedor Nato',
                'Termine sua primeira trilha de aprendizado',
                '40',
                'Conquistado em 28/07/2023 às 14:12',
                'assets/graduacao.png'),
            Container(height: 10),
            card('Um bom começo', 'Concluiu os primeiros passos', '60',
                'Conquistado em 27/07/2023 às 19:56', 'assets/verificado.png'),
          ],
        ),
      ),
    );
